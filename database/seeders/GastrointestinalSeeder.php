...
class GastrointestinalSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $vdx_gastrointestinal = [];
        $vdx_gastrointestinal_file_path = __DIR__ . '/source/vdx_gastrointestinal.csv';
       
        $vdx_gastrointestinal_file = file($vdx_gastrointestinal_file_path);

        $vdx_gastrointestinal_data_collection = array_slice($vdx_gastrointestinal_file, 1);
        ...
        foreach($vdx_gastrointestinal_chunched as $vdxs) {
            ...
            DB::table('masters')->insertOrIgnore($vdx_gastrointestinal_data);
        }

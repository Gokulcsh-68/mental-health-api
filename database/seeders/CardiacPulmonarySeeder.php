        ...
        foreach($vdx_cardiac_pulmonary_chunched as $vdxs) {
            ...
            foreach($vdxs as $item) {
                ...
                if(!empty($data[1])){
                    ...
                    $slug = strtolower('cardi1'.$rmv_slug_string);
                    ...
                    if(!empty($data[2])){
                        ...
                        $slug2 = strtolower('cardi2'.$main_name.preg_replace('/[^A-Za-z0-9\-]/', '', $slug_string2));
                    ...
                    if(!empty($name2)){
                        ...
                        if(!empty($data[3])){
                            ...
                            $slug3 = strtolower('cardi3'.$main_name.preg_replace('/[^A-Za-z0-9\-]/', '', $slug_string3));
                        ...
                        if(!empty($name3)){
                            ...
                            if(!empty($data[4])){
                                ...
                                $slug4 = strtolower('cardi4'.$main_name.preg_replace('/[^A-Za-z0-9\-]/', '', $slug_string4));

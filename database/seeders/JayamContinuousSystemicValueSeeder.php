...
class JayamContinuousSystemicValueSeeder extends Seeder
{
    ...
    {
        $master_types = [
            [ 'slug' => 'jayam_continuous_sub_types'],
            [ 'slug' => 'jayam-continuous-examination']
        ];
    ...
    {
        $sys_file_path = __DIR__ . '/source/jayam_continuousHead.csv';
        ...
        foreach($sys_chunched as $syss) {
            ...
            foreach($syss as $item) {
                ...
                $sys_data[] = [
                    'master_type_slug' => 'jayam-continuous-examination', 
                    'slug' => $slug, 
                    'name' => $name,
    ...
    {
        $sys_file_path = __DIR__ . '/source/jayam_continuousValue.csv';
        $sys_file = file($sys_file_path);
        $sys_data_collection = array_slice($sys_file, 0);

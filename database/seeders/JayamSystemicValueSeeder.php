...
class JayamSystemicValueSeeder extends Seeder
{
    /**
    ...
    {
        $master_types = [
            [ 'slug' => 'jayam_systemic_sub_types'],
            [ 'slug' => 'jayam-systemic-examination']
        ];
        
        DB::table('master_types')->insertOrIgnore($master_types);

        Schema::disableForeignKeyConstraints();
        DB::table('masters')->Where('master_type_slug','jayam_systemic_sub_types')->delete();
        DB::table('masters')->Where('master_type_slug','jayam-systemic-examination')->delete();
    ...
    {
        $sys_file_path = __DIR__ . '/source/jayam_systemicHead.csv';
        ...
        foreach($sys_chunched as $syss) {
            ...
            foreach($syss as $item) {
                ...
                $sys_data[] = [
                    'master_type_slug' => 'jayam-systemic-examination', 
                    'slug' => $slug, 
                    'name' => $name,
    ...
    {
        $sys_file_path = __DIR__ . '/source/jayam_systemicValue.csv';
        $sys_file = file($sys_file_path);
        $sys_data_collection = array_slice($sys_file, 0);
        ...
        foreach($sys_chunched as $syss) {
            ...
            foreach($syss as $item) {
                ...
                $sys_data[] = [
                    'master_type_slug' => 'jayam_systemic_sub_types', 
                    'slug' => $slug, 
                    'name' => $name,

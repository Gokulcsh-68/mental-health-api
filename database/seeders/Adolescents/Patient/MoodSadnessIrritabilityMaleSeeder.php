...
class MoodSadnessIrritabilityMaleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->addMoodQuestions($forms['male_adolescents_mood'], $questions, $answers);

        $this->command->info(
            'DSM-5 aligned Mood, Sadness & Irritability (Male Adolescents 13–17 years) seeded successfully!'
        );
    }
    ...
    private function createForms(): array
    {
        ...
        $data = [
            'name'             => 'Male Adolescents – Mood, Sadness & Irritability',
            'desc'             => 'Self or parent-reported mood changes, sadness, irritability, and emotional dysregulation in male adolescents (13–17 years, DSM-5 aligned, non-diagnostic)',
            'assessment_group' => 'male-adolescents-mood',
            'type'             => 'score',
            'slug'             => 'male-adolescents-mood',
            'is_active'        => 1,
            'role_code'        => $rolesJson,
        ...
        return [
            'male_adolescents_mood' => Form::where('slug', $data['slug'])->value('id')
        ];
    }

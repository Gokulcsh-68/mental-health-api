...
class AnxietyNervousnessWorryFemaleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->addAnxietyQuestions($forms['female_adolescents_anxiety'], $questions, $answers);

        $this->command->info(
            'DSM-5 aligned Anxiety, Nervousness & Worry (Female Adolescents 13–17 years) seeded successfully!'
        );
    }
    ...
    private function createForms(): array
    {
        ...
        $data = [
            'name'             => 'Female Adolescents – Anxiety, Nervousness & Worry',
            'desc'             => 'Self or parent-reported anxiety, nervousness, and worry in female adolescents (13–17 years, DSM-5 aligned, non-diagnostic)',
            'assessment_group' => 'female-adolescents-anxiety',
            'type'             => 'score',
            'slug'             => 'female-adolescents-anxiety',
            'is_active'        => 1,
            'role_code'        => $rolesJson,
        ...
        return [
            'female_adolescents_anxiety' => Form::where('slug', $data['slug'])->value('id')
        ];
    }

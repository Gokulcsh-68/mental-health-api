...
class ROSTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $ros = [
            ...
            ['slug' => "eye", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'glaucoma_cataracts', 'label' => 'Glaucoma / Cataracts', 'data' => 'eye_glaucoma_cataracts'])],
            ...
            ['slug' => "mouth_throat", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'bleeding_gums', 'label' => 'Bleeding gums', 'data' => 'mouth_throat_bleeding_gums'])],
            ['slug' => "mouth_throat", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'sore_tongue', 'label' => 'Sore tongue', 'data' => 'mouth_throat_sore_tongue'])],
            ['slug' => "mouth_throat", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'sore_throat', 'label' => 'Sore throat', 'data' => 'mouth_throat_sore_throat'])],
            ['slug' => "mouth_throat", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'hoarseness', 'label' => 'Hoarseness', 'data' => 'mouth_throat_hoarseness'])],
            ['slug' => "mouth_throat", 'attributes' => json_encode(['type' => 'textarea', 'name' => 'notes', 'label' => 'Notes', 'data' => 'mouth_throat_notes_notes'])],
            ...
            ['slug' => "respiratory", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'production_of_phlegm_color', 'label' => 'Production of phlegm, color', 'data' => 'respiratory_production_of_phlegm_color'])],
            ...
            ['slug' => "cardiovascular", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'palpitations', 'label' => 'palpitations', 'data' => 'cardiovascular_palpitations'])],
            ['slug' => "cardiovascular", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'swelling_in_hands_feet', 'label' => 'Swelling in hands/feet', 'data' => 'cardiovascular_swelling_in_hands_feet'])],
            ['slug' => "cardiovascular", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'blue_fingers_toes', 'label' => 'Blue fingers/toes', 'data' => 'cardiovascular_blue_fingers_toes'])],
            ...
            ['slug' => "gastrointestinal", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'abdominal_pain', 'label' => 'Abdominal Pain', 'data' => 'gastrointestinal_abdominal_pain'])],
            ['slug' => "gastrointestinal", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'change_of_appetite', 'label' => 'Change of appetite', 'data' => 'gastrointestinal_change_of_appetite'])],
            ['slug' => "gastrointestinal", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'weight_loss', 'label' => 'Weight Loss', 'data' => 'gastrointestinal_weight_loss'])],
            ['slug' => "gastrointestinal", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'problems_swallowing', 'label' => 'Problems swallowing', 'data' => 'gastrointestinal_problems_swallowing'])],
            ['slug' => "gastrointestinal", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'nausea', 'label' => 'Nausea', 'data' => 'gastrointestinal_nausea'])],
            ['slug' => "gastrointestinal", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'heartburn', 'label' => 'Heartburn', 'data' => 'gastrointestinal_heartburn'])],
            ['slug' => "gastrointestinal", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'vomiting', 'label' => 'Vomiting', 'data' => 'gastrointestinal_vomiting'])],
            ['slug' => "gastrointestinal", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'vomiting_blood', 'label' => 'Vomiting blood', 'data' => 'gastrointestinal_vomiting_blood'])],
            ['slug' => "gastrointestinal", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'constipation', 'label' => 'Constipation', 'data' => 'gastrointestinal_Constipation'])],
            ['slug' => "gastrointestinal", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'diarrhoea', 'label' => 'Diarrhoea', 'data' => 'gastrointestinal_diarrhoea'])],
            ['slug' => "gastrointestinal", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'change_in_bowel_habits', 'label' => 'Change in bowel habits', 'data' => 'gastrointestinal_change_in_bowel_habits'])],
            ['slug' => "gastrointestinal", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'excessive_belching', 'label' => 'Excessive belching', 'data' => 'gastrointestinal_excessive_belching'])],
            ['slug' => "gastrointestinal", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'excessive_flatus', 'label' => 'Excessive flatus', 'data' => 'gastrointestinal_excessive_flatus'])],
            ['slug' => "gastrointestinal", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'yellow_color_of_skin', 'label' => 'Yellow color of skin', 'data' => 'gastrointestinal_yellow_color_of_skin'])],
            ['slug' => "gastrointestinal", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'food_intolerance', 'label' => 'food intolerance', 'data' => 'gastrointestinal_food_intolerance'])],
            ['slug' => "gastrointestinal", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'rectal_bleeding', 'label' => 'rectal bleeding', 'data' => 'gastrointestinal_rectal_bleeding'])],
            ['slug' => "gastrointestinal", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'hemorrhoids', 'label' => 'hemorrhoids', 'data' => 'gastrointestinal_hemorrhoids'])],
            ...
            ['slug' => "genito_urinary", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'uti_stones_prostate', 'label' => 'UTI/stones/prostate', 'data' => 'genito_urinary_uti_stones_prostate'])],
            ...
            ['slug' => "neurology", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'feeling_of_pins_and_needles_tingles', 'label' => 'Feeling of “pins and needles/tingles”, Bleeding Ulcers', 'data' => 'neurology_feeling_of_pins_and_needles_tingles'])],
            ...
            ['slug' => "hematology", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'easy_bruising_bleeding', 'label' => 'Easy bruising/bleeding', 'data' => 'hematology_easy_bruising_bleeding'])],
            ...
            ['slug' => "psychiatry", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'tension_anxiety', 'label' => 'Tension/Anxiety', 'data' => 'psychiatry_tension_anxiety'])],
            ['slug' => "psychiatry", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'depression_suicide_ideation', 'label' => 'Depression/suicide ideation', 'data' => 'psychiatry_depression_suicide_ideation'])],
            ...
            ['slug' => "endocrine", 'attributes' => json_encode(['type' => 'checkbox', 'name' => 'heat_cold_intolerance', 'label' => 'Heat/cold intolerance', 'data' => 'endocrine_heat_cold_intolerance'])],

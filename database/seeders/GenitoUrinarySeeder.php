...
class GenitoUrinarySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $vdx_genito_urinary = [];
        $vdx_genito_urinary_file_path = __DIR__ . '/source/vdx_genito_urinary.csv';
       
        $vdx_genito_urinary_file = file($vdx_genito_urinary_file_path);

        $vdx_genito_urinary_data_collection = array_slice($vdx_genito_urinary_file, 1);
        ...
        foreach($vdx_genito_urinary_chunched as $vdxs) {
            ...
            DB::table('masters')->insertOrIgnore($vdx_genito_urinary_data);
        }

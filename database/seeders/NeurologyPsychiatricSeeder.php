...
class NeurologyPsychiatricSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $vdx_neurology_psychiatric = [];
        $vdx_neurology_psychiatric_file_path = __DIR__ . '/source/vdx_neurology_psychiatric.csv';
       
        $vdx_neurology_psychiatric_file = file($vdx_neurology_psychiatric_file_path);

        $vdx_neurology_psychiatric_data_collection = array_slice($vdx_neurology_psychiatric_file, 1);
        ...
        foreach($vdx_neurology_psychiatric_chunched as $vdxs) {
            ...
            DB::table('masters')->insertOrIgnore($vdx_neurology_psychiatric_data);
        }

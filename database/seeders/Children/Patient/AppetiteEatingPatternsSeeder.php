...
class AppetiteEatingPatternsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->addAppetiteEatingQuestions(
            $forms['appetite_eating_patterns'],
            $questions,
            $answers
        );

        $this->command->info(
            'DSM-5 aligned Appetite & Eating Patterns (6–12 years) seeded successfully!'
        );
    }
    ...
    private function createForms(): array
    {
        ...
        $data = [
            'name'             => 'Children – Appetite & Eating Patterns',
            'desc'             => 'Self or parent-reported appetite and eating patterns (DSM-5 aligned, non-diagnostic)',
            'assessment_group' => 'children-appetite-eating',
            'type'             => 'score',
            'slug'             => 'children-appetite-eating',
            'is_active'        => 1,
            'role_code'        => $rolesJson,
        ...
        return [
            'appetite_eating_patterns' =>
                Form::where('slug', $data['slug'])->value('id')
        ];
    }

    /**
     * Appetite & Eating Patterns Questions (6–12)
     */
    private function addAppetiteEatingQuestions(
        int $formId,
        array &$questions,
        array &$answers
    ): void {
        ...
        $questionsData = [
            'Has irregular meal patterns',
            'Skips meals frequently',
            'Overeats or binge eats',
            'Shows reluctance to try new foods',
            'Complains of loss of appetite',
            'Eats very slowly or with difficulty',
            'Displays emotional eating patterns',
            'Experiences conflicts around food or mealtimes',
        ];

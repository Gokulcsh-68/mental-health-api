...
class EmailApiService extends BaseService {
	...
	{
		parent::__construct();
		$this->endpoint_url = $this->_base_url . 'v1/communication/send/email';
	}
	 ...
	 * @return mixed
	 */
	public function send(array $to, string $subject, string $message, string $iso_code)
    {
    	try {
